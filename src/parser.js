...
var Parser = Object.extend({
    ...
    parseIf: function() {
        ...
        if(this.skipSymbol('if') || this.skipSymbol('elseif')) {
            ...
            this.fail('parseIf: expected if or elseif',
                      tag.lineno,
                      tag.colno);
        }
        ...
        node.body = this.parseUntilBlocks('elseif', 'else', 'endif');
        var tok = this.peekToken();
        ...
        case 'endif':
            ...
            break;
        default:
            this.fail('parseIf: expected elseif, else, or endif, ' +
                      'got end of file');
        }
